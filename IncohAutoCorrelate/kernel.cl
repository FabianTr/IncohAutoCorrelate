...
__kernel void calc_AutoCorr(__global const float *Intensity,
	__global const double *Params,
	__global double *AutoCorr,
	__global double *AutoCorrWeight)
{
	int ind = get_global_id(0);
	//double Params[5];
	//Params[0] = DetSize; //Pixelnumber
	//Params[1] = deltaV; //Voxel Unit
	//Params[2] = extPerp; //width / length perpendicular to z
	//Params[3] = extZ; //depth z
	//Params[4] = Interpolation; //Interpolation Flag [0: nearest neighbor; 1: linear]
	//Params[5] = Distance; //Detector Distance
