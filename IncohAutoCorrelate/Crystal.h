...
private:
	...
	void Create_Lattice(double LatticeVector[3][3], unsigned int l, unsigned int m, unsigned int n);
	void Create_Crystal(unsigned int l, unsigned int m, unsigned int n, std::vector<std::array<double, 3>> UnitCell);
