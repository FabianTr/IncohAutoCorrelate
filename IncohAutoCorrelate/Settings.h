...
public:
	const static int XML_HITLIST_VERSION = 5; //Mmm (1.00 -> 100; 1.01 -> 101; 0.1 -> 10)
	const static int INTERNAL_VERSION = 6; //Mmm (1.00 -> 100; 1.01 -> 101; 0.1 -> 10)
	const static int INTERNAL_VERSION_Revision = 1; //rr
